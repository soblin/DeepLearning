...
int main(){
    ...
    std::cout << "cuMat + cuMat" << std::endl; C = A + B; std::cout << C;    //OK
    std::cout << "cuMat - cuMat" << std::endl; C = A - B; std::cout << C;    //OK
    std::cout << "cuMat * cuMat" << std::endl; C = A * B; std::cout << C;    //OK
    std::cout << "cuMat / cuMat" << std::endl; C = A / B; std::cout << C;    //OK

    std::cout << "cuMat + float" << std::endl; C = A + 2; std::cout << C;    //OK
    std::cout << "cuMat + (-float)" << std::endl; C = A + (-2); std::cout << C; //OK
    std::cout << "float + cuMat" << std::endl; C = 2 + A; std::cout << C;    //OK
    std::cout << "cuMat * float" << std::endl; C = A * 2; std::cout << C;    //OK
    std::cout << "float * cuMat" << std::endl; C = 2 * A; std::cout << C;    //OK
    std::cout << "cuMat / float" << std::endl; C = A / 2; std::cout << C;    //OK
    std::cout << "float / cuMat" << std::endl; C = 20 / A; std::cout << C;   //OK

    std::cout << "Test of matrix-production" << std::endl;
    C = A.dot(B); std::cout << C; //OK
    return 0;
}
